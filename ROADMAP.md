...
- [ ] **Schedule store** -- Encrypted JSON at `~/.config/nevinho/schedules.enc`. Each entry: ID, name, cron expression, prompt, enabled flag, last_run, next_run. Uses existing crypto package.
